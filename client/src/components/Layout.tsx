...
const moreMenuItems = [
  ...
  { path: "/yield",       label: "Yield",     icon: Gauge      },
  { path: "/fiscal",      label: "Fiscal+",   icon: PiggyBank  },
  { path: "/signals",     label: "Signaux",   icon: Zap        },
  { path: "/crm",         label: "CRM",       icon: Users      },
  { path: "/coach",       label: "Coach",     icon: Mic        },
  { path: "/arbitrage",   label: "Arbitrage", icon: RadarIcon  },
  { path: "/diversification", label: "Diversif.", icon: Package },
  { path: "/vehicule",    label: "Véhicule",  icon: Car        },
  { path: "/sante",       label: "Santé",     icon: Heart      },
  { path: "/finance",     label: "Finance",   icon: Wallet     },
  { path: "/trust",       label: "Trust",     icon: ShieldCheck },
  { path: "/analytics",   label: "Analytics", icon: BarChart3  },
  { path: "/onboarding",  label: "Onboarding", icon: Rocket    },
  { path: "/legal",       label: "Juridique", icon: Scale      },
